...
router.beforeEach(async (to, from, next) => {
    ...
    if (['/financeiro/analise-de-credito'].includes(to.path)) {
      ...
      const allowedIds = [705, 193, 189, 431, 157, 823, 545, 1, 294]; //Paloma, Ailton, Natali, Everson, Sthefany, Kesley, Elaine e Alex.
    ...
    if (['/financeiro/pdf-nf'].includes(to.path)) {
        ...
        const allowedIds = [431, 157, 839, 385, 298, 494, 1, 680]; //Ailton, Everson, Jefferson, Juliana, Rafael, Wesley, Carlos, Mathias Summer
