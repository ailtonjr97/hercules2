<template>
    ...
    <table-top :resultados="resultados">
        <template v-slot:tableButtons>
            <button v-if="!mostraArquivadas && (idLogado == 452 || idLogado == 705 || idLogado == 193 || idLogado == 189 || idLogado == 823 || idLogado == 894 || idLogado == 931)" class="button-8 mb-2" @click="refresh()">Atualizar</button>
            ...
            <td>
                <div class="row" style="width: 80%; margin-left: 15%;">
                    <div class="col d-flex justify-content-center">
                        <button v-if="idLogado == 705 || idLogado == 193 || idLogado == 189 || idLogado == 823 || idLogado == 894 || idLogado == 931" title="Arquivar" class="button-8" @click="confirmaArquivar(resposta.ID)">Arquivar</button>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row mt-2">
                            <div class="col d-flex justify-content-start">
                                ...
                                <div v-if="!mostraArquivadas && (idLogado == 452 || idLogado == 705 || idLogado == 193 || idLogado == 189 || idLogado == 431 || idLogado == 894 || idLogado == 931)" style="margin-left: 2%;"><button title="Solicitar Documentos ao Cliente." class="button-8" @click="perguntarDispararEmailCliente(infoDocumento.COD_CLIENTE, infoDocumento.LOJA, infoDocumento.ID, infoDocumento.EMAIL, infoDocumento.NOME_CLIENTE)">E-mail</button></div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col d-flex justify-content-start">
                                <form-span :readonly="true" :span="'Doc. OK'" v-model="infoDocumento.DATA_DOC_OK"></form-span>
                                <div v-if="!mostraArquivadas && (idLogado == 452 || idLogado == 705 || idLogado == 193 || idLogado == 189 || idLogado == 431 || idLogado == 894 || idLogado == 931)"><button title="Documentos OK." class="button-8" @click="perguntaDocOk(infoDocumento.ID, infoDocumento.VALOR_PEDIDO_INALTERADO)">Escolher</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mt-2">
                            <div class="col d-flex justify-content-evenly">
                                ...
                                <div style="margin-left: 0.5%;" v-if="!mostraArquivadas && infoDocumento.ARQUIVA == 0 && (idLogado == 705 || idLogado == 193 || idLogado == 189 || idLogado == 431 || idLogado == 823 || idLogado == 894 || idLogado == 931)"><button title="Trocar Responsável" class="button-8" @click="trocaResp(infoDocumento.ID, infoDocumento.RESPONSAVEL_APROV)">Escolher</button></div>
                            </div>
                        </div>
<!--                         <div class="row mt-2">
                            <div class="col-lg-12">
    ...
    computed: {
        ...
        optionsRespAprov(){
            return [
                ...
                {valor: "Rosangela Costa dos Anjos", descri: 'Rosangela Costa dos Anjos'}
            ];
        },
        optionsPercent(){
            return [
